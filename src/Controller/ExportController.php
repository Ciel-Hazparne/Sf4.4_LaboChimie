...
class ExportController extends AbstractController
{
    ...
    public function __construct(EntityManagerInterface $entityManager, SessionInterface $session, ProduitChimiqueRepository $produitChimiqueRepository)
    {

        $this->entityManager = $entityManager;
        $this->session = $session;
        $this->repo = $produitChimiqueRepository;
    }
    /**
    * permet de recuper les elements du panier
    */
    private function getData(): array
    {
        ...
        foreach ($panier as $id => $quantity) {
            $list[] = [
                ...
                'designation' => $this->repo->find($id)->getFormule(),
                'quantity' => $quantity
            ];
        }
        return $list;
    ...
    /**
     * Permet à l'admin de pouvoir exporter son panier en format excel
    ...
    public function export(): RedirectResponse
    {
        ...
        $sheet->getCell('C2')->setValue('Demande de devis');
        ...
        $sheet->getCell('C9')->setValue('Route des Missionnaires - 64240 HASPARREN');
        $spreadsheet->getActiveSheet()->getColumnDimension('D')->setWidth('33');
        $spreadsheet->getActiveSheet()->getColumnDimension('C')->setWidth('20');
        $sheet->getCell('C10')->setValue('Tél : 05.59.70.29.30  -  Fax : 05.59.70.29.31');
        ...
        $sheet->getCell('C16')->setValue('Chef de Travaux');
        $spreadsheet->getActiveSheet()->getStyle('C16')->getFont()->setBold('true');
        $spreadsheet->getActiveSheet()->getCell('D16')->getHyperlink()->setUrl('chefdetravaux@st-joseph-hasparren.fr');
        $sheet->getCell('D16')->setValue('chefdetravaux@st-joseph-hasparren.fr');
